...
/**
 * Protege /api/pedidos/*: exige sessão com perfil cliente. Responde sempre em
 ...
 */
@WebFilter("/api/pedidos/*")
public class ApiClienteFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        if (!usuarioLogado.isCliente()) {
            JsonUtil.erro(response, HttpServletResponse.SC_FORBIDDEN, "Acesso restrito a clientes.");
            return;
        }
