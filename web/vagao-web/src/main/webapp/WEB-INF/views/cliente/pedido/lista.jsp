...
<head>
    <meta charset="UTF-8">
    <title>VAGÃO — Meus Pedidos</title>
    <style>
        ...
        <div class="painel">
            <c:choose>
                <c:when test="${empty pedidos}">
                    <p>Você ainda não fez nenhum pedido.
                        <a href="${pageContext.request.contextPath}/cliente/catalogo">Ver catálogo</a>.
                    </p>
                </c:when>
                <c:otherwise>
                    <div class="tabela-wrap">
                        <table>
                            <thead>
                                <tr><th>Nº</th><th>Data</th><th>Total</th><th>Status</th><th></th></tr>
                            </thead>
                            <tbody>
                                <c:forEach var="p" items="${pedidos}">
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sec" href="${pageContext.request.contextPath}/cliente/pedidos/detalhe?id=${p.idPedido}">Ver detalhes</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
