...
<body>
    ...
    <main>
        <div class="cabecalho-lista">
            <h1>Categorias</h1>
            <a class="btn" href="${pageContext.request.contextPath}/admin/categorias/novo">+ Nova categoria</a>
        </div>
                            ...
                            <tbody>
                                <c:forEach var="c" items="${categorias}">
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sec" href="${pageContext.request.contextPath}/admin/categorias/editar?id=${c.idCategoria}">Editar</a>
                                            <a class="btn btn-perigo" href="${pageContext.request.contextPath}/admin/categorias/excluir?id=${c.idCategoria}">Excluir</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
